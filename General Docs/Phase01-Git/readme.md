...
هر چیزی در گیت قبل از اینکه ذخیره شود چک‌سام می‌شود و سپس متعاقباً با آن چک‌سام فراخوانی می‌شود. این بدان معناست که غیرممکن است که محتوای فایل یا پوشه‌ای را بدون اینکه گیت متوجه شود ویرایش کنید. این کاکرد درون گیت و در پایین‌ترین مرتبه‌ها ساختار یافته و با تاروپود فلسفه‌اش همراه است. ممکن نیست که شما اطلاعات را حین انتقال یا بر اثر خرابی از دست بدهید بدون اینکه گیت آن را تشخیص دهد.
...
***برای اطلاعات بیشتر می‌توانید به این [لینک](https://git-scm.com/book/en/v2/Getting-Started-About-Version-Control) مراجعه کنید.***
...
***برای اطلاعات بیشتر به این [لینک](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git) مراجعه کنید.***
...
* استیج‌شده به این معناست که شما ویرایشی در نسخه حال فایل را علامت‌گذاری کرده‌اید تا به اسنپ‌شاتِ کامیت بعدی شما اضافه شود.
...
***برای اطلاعات بیشتر این [لینک](https://git-scm.com/book/en/v2/Git-Basics-Recording-Changes-to-the-Repository) را مطالعه بفرمایید.***
...
***برای مطالعه بیشتر به این [لینک](https://git-scm.com/book/en/v2/Git-Basics-Getting-a-Git-Repository) مراجعه کنید.***
...
***برای اطلاعات بیشتر به این [لینک](https://git-scm.com/book/en/v2/Git-Basics-Viewing-the-Commit-History)  مراجعه کنید.***
...
***برای مطالعه‌ی بیشتر به این [لینک](https://git-scm.com/book/en/v2/Git-Basics-Undoing-Things) مراجعه کنید.***
...
* __فچ و پول کردن از ریموت‌ها:__
...
***برای مطالعه‌ی بیشتر به این [لینک](https://git-scm.com/book/en/v2/Git-Basics-Working-with-Remotes) مراجعه کنید.***
...
![Git image 2](https://github.com/MARS-JSU/Internship-Documents/blob/Back-End/General%20Docs/Phase01-Git/Picture2.png )


* __در هنگام کامیت چه چیزی ذخیره می‌شود؟__
...
* __وقتی یک برنچ جدید می‌سازید چه اتفاقی می‌افتد؟__
...
* __چگونه گیت می‌داند که روی چه شاخه‌ای کار می‌کنید؟__
...
![Git image 3](https://github.com/MARS-JSU/Internship-Documents/blob/Back-End/General%20Docs/Phase01-Git/Picture3.png )
...
![Git image 4](https://github.com/MARS-JSU/Internship-Documents/blob/Back-End/General%20Docs/Phase01-Git/Picture4.png )

![Git image 5](https://github.com/MARS-JSU/Internship-Documents/blob/Back-End/General%20Docs/Phase01-Git/Picture5.png )


***برای مطالعه‌ی بیشتر درباره‌ی برنچ‌ها می‌توانید از این [لینک](https://git-scm.com/book/en/v2/Git-Branching-Branches-in-a-Nutshell) استفاده کنید.***
